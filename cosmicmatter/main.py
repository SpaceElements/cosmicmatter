...
"""
Example application using Cosmic Matter library
"""
...
someVariable = Equipment(
    "shield", "sword", "helmet", "private cert 1", "privatecert2", "privatecert3"
)
...
def room_1000():
    ...
    print(
        bcolors.GREY +
        "In the middle of the floor, the words Nosce Te Ipsum glow.")
...
def room_1005():
    ...
    print(
        bcolors.GREY
        + "A mysterious man is walking around with a clipboard, taking notes."
    )
    print(bcolors.GREY + "The man looks up at you and asks:.")
    print("")
    print(
        bcolors.WHITE
        + "-> 'I wonder if you happen to have an opinion on who the best cloud provider might be?'"
        + bcolors.ENDC
    )
    initial_menu()
...
def areaOfSquare():
    ...
    print(bcolors.GREY + "" + bcolors.ENDC)
    print(
        bcolors.WHITE + "We shall now calculate the area of the square:" + bcolors.ENDC
    )
...
def initial_menu():
    ...
    if menuChoice == "east" or menuChoice == "e":
        ...
        print(
            bcolors.GREY +
            "A holographic being acknolwedges your request and says:")
        print(bcolors.GREY + "" + bcolors.ENDC)
        print(
            bcolors.WHITE
            + "-> 'Your wish is my command. The batch has been executed.'"
            + bcolors.ENDC
        )
        import subprocess

        subprocess.call(
            [r"C:\Users\Space\Desktop\Scripts\batch-obtain-local-copy-of-images.bat"]
        )
        print(bcolors.GREY + "" + bcolors.ENDC)
        print(
            bcolors.WHITE
            + "-> 'The hologram releases his grasp from your hand.'"
            + bcolors.ENDC
        )
        initial_menu()
        ...
        subprocess.call(
            [r"C:\Users\Space\Desktop\Scripts\batch-script-make-directories.bat"]
        )
        print(bcolors.GREY + "" + bcolors.ENDC)
        print(
            bcolors.WHITE
...
def credits():
    print(
        ...
        bcolors.ENDC)
    print(
        bcolors.GREY + " ->" + " " + bcolors.SOFTCYAN + "Cosmic Matter" + bcolors.ENDC
    )
    print(
        bcolors.GREY + " -> Version:" + " " + bcolors.SOFTGREEN + "0.01a" + bcolors.ENDC
    )
    print(
        bcolors.GREY
        + " -> Release:"
